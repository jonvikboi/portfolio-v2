...
const MorphingIcon = ({ type, isActive, onMouseEnter }: { type: string, isActive: boolean, onMouseEnter?: () => void }) => {
    ...
    if (type === 'home') {
        return (
            <button ref={buttonRef} onMouseEnter={handleMouseEnter} className={cn("home transition-colors duration-200", isActive ? "text-primary" : "text-gray-400")}>
    ...
    if (type === 'blog') {
        return (
            <button ref={buttonRef} onMouseEnter={handleMouseEnter} className={cn("blog transition-colors duration-200", isActive ? "text-primary" : "text-gray-400")}>
                <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current">
    ...
    if (type === 'marker') {
        return (
            <button ref={buttonRef} onMouseEnter={handleMouseEnter} className={cn("marker transition-colors duration-200", isActive ? "text-primary" : "text-gray-400")}>
                <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current">
    ...
    if (type === 'email') {
        return (
            <button ref={buttonRef} onMouseEnter={handleMouseEnter} className={cn("email transition-colors duration-200", isActive ? "text-primary" : "text-gray-400")}>
                <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current">
    ...
    if (type === 'linkedin') {
        return (
            <button ref={buttonRef} onMouseEnter={handleMouseEnter} className={cn("linkedin transition-colors duration-200", isActive ? "text-primary" : "text-gray-400")}>
                <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current">
    ...
    if (type === 'x') {
        return (
            <button ref={buttonRef} onMouseEnter={handleMouseEnter} className={cn("x transition-colors duration-200", isActive ? "text-primary" : "text-gray-400")}>
                <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current">
    ...
    if (type === 'github') {
        return (
            <button ref={buttonRef} onMouseEnter={handleMouseEnter} className={cn("github transition-colors duration-200", isActive ? "text-primary" : "text-gray-400")}>
                <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current">
            ...
            >
                <div
                    className={cn(
                        ...
                        "glass-border bg-black/80 border border-crimson/30",
                        ...
                        const handleClick = () => {
                            if (el.onClick) {
                                ...
                                if (el.href.startsWith('mailto:')) {
                                    ...
                                    window.open(el.href, el.target || '_blank', 'noopener,noreferrer');
                                }
                            }
                        };
